...
export default function AlunosDoPersonal() {
          ...
          return (
            <div
              ...
              style={{
                ...
                cursor: alunoPage ? "pointer" : "default",
              }}
              onClick={() => {
                if (alunoPage) {
                  window.location.href = `/aluno/${alunoPage}`;
                }
              }}
              onMouseEnter={(e) => {
            ...
            >
              ...
              {whatsapp && (
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation(); // não navegar para /aluno quando clicar no botão
                    window.open(
