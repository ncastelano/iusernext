    ...
    <ul className="flex flex-col space-y-6">
      {videos.map((video) => (
        <li key={video.videoID}>
          <Link href={`/${user.name}/${video.videoID}`} className="block group">
            <div className="relative">
              <Image
                ...
                width={320}
                height={180}
                className="rounded-lg object-cover cursor-pointer shadow-lg transition-transform group-hover:scale-105"
              />
